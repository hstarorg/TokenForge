  ...
  return (
    ...
    >
      ...
      <Field
        label="Metadata URI"
        value={form.uri}
        onChange={(v) => vm.setField("uri", v)}
        hint="Optional. Off-chain JSON with image and extra metadata."
      />
      ...
      <fieldset className="features">
        ...
        />
        <Checkbox
          label="Set freeze authority (you can freeze accounts)"
          checked={form.enableFreeze}
          onChange={(v) => vm.setField("enableFreeze", v)}
        />
      </fieldset>
